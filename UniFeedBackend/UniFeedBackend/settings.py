"""
Django settings for UniFeedBackend project.
...
SECRET_KEY = 'django-insecure-ktcv2m+is-%^!4(^qo4*@xlyyor(1f1u2p25i(m=+zp_jg785='
...
WSGI_APPLICATION = 'UniFeedBackend.wsgi.application'
